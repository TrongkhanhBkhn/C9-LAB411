...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/RF315Router.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=LCD/LCD.c UART/UART.c TIMER/TIMER.c CC1101/CC1101.c SPI/SPI.c RFRouter.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/LCD/LCD.o ${OBJECTDIR}/UART/UART.o ${OBJECTDIR}/TIMER/TIMER.o ${OBJECTDIR}/CC1101/CC1101.o ${OBJECTDIR}/SPI/SPI.o ${OBJECTDIR}/RFRouter.o
POSSIBLE_DEPFILES=${OBJECTDIR}/LCD/LCD.o.d ${OBJECTDIR}/UART/UART.o.d ${OBJECTDIR}/TIMER/TIMER.o.d ${OBJECTDIR}/CC1101/CC1101.o.d ${OBJECTDIR}/SPI/SPI.o.d ${OBJECTDIR}/RFRouter.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/LCD/LCD.o ${OBJECTDIR}/UART/UART.o ${OBJECTDIR}/TIMER/TIMER.o ${OBJECTDIR}/CC1101/CC1101.o ${OBJECTDIR}/SPI/SPI.o ${OBJECTDIR}/RFRouter.o

# Source Files
SOURCEFILES=LCD/LCD.c UART/UART.c TIMER/TIMER.c CC1101/CC1101.c SPI/SPI.c RFRouter.c
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE} ${MAKE_OPTIONS} -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/RF315Router.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/RFRouter.o: RFRouter.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/RFRouter.o.d 
	@${RM} ${OBJECTDIR}/RFRouter.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/RFRouter.o   RFRouter.c 
	@${DEP_GEN} -d ${OBJECTDIR}/RFRouter.o 
	@${FIXDEPS} "${OBJECTDIR}/RFRouter.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
...
${OBJECTDIR}/RFRouter.o: RFRouter.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/RFRouter.o.d 
	@${RM} ${OBJECTDIR}/RFRouter.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/RFRouter.o   RFRouter.c 
	@${DEP_GEN} -d ${OBJECTDIR}/RFRouter.o 
	@${FIXDEPS} "${OBJECTDIR}/RFRouter.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/RF315Router.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_LD} $(MP_EXTRA_LD_PRE)   -p$(MP_PROCESSOR_OPTION_LD)  -w -x -u_DEBUG -m"${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"  -z__MPLAB_BUILD=1  -u_CRUNTIME -z__MPLAB_DEBUG=1 -z__MPLAB_DEBUGGER_PK3=1 $(MP_LINKER_DEBUG_OPTION) -l ${MP_CC_DIR}\\..\\lib  -o dist/${CND_CONF}/${IMAGE_TYPE}/RF315Router.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}   
else
dist/${CND_CONF}/${IMAGE_TYPE}/RF315Router.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_LD} $(MP_EXTRA_LD_PRE)   -p$(MP_PROCESSOR_OPTION_LD)  -w  -m"${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"  -z__MPLAB_BUILD=1  -u_CRUNTIME -l ${MP_CC_DIR}\\..\\lib  -o dist/${CND_CONF}/${IMAGE_TYPE}/RF315Router.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}   
endif
